...
#ifndef _HELTECMD_DS3231_h
#define _HELTECMD_DS3231_h
...
public:
	...
	*/
	...
	/**
	* Overloaded Class Constructor (HELTEC only)
	*
	* Provides a way to pass in a TwoWire reference
	* if the device supports multiple I2C interfaces
	*
	* \param myWire  Reference to TwoWire instance to use
	*/
	MD_DS3231(TwoWire * myWire);
